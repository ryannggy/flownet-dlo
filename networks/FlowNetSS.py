...
class FlowNetSS(nn.Module):
    def __init__(self, args, input_channels=12, batchNorm=True):
        super(FlowNetSS, self).__init__()

        self.batchNorm = batchNorm
        self.conv1 = conv(self.batchNorm,  input_channels,32, kernel_size=7, stride=2)
        ...
        self.deconv4 = deconv(514, 128)
        self.deconv3 = deconv(386, 64)
        ...
        self.predict_flow2 = predict_flow(89)
