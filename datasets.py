...
class MpiSintel(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        img8 = frame_utils.read_gen(self.image_list[index][6])
        ...
        img18 = frame_utils.read_gen(self.image_list[index][16])
        ...
        img28 = frame_utils.read_gen(self.image_list[index][26])
        ...
        img38 = frame_utils.read_gen(self.image_list[index][36])
        ...
        img48 = frame_utils.read_gen(self.image_list[index][46])
        ...
        img58 = frame_utils.read_gen(self.image_list[index][56])
        ...
        img68 = frame_utils.read_gen(self.image_list[index][66])
        ...
        img88 = frame_utils.read_gen(self.image_list[index][86])
        ...
        img98 = frame_utils.read_gen(self.image_list[index][96])
