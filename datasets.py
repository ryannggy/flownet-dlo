...
class ImagesFromFolder(data.Dataset):
  def __init__(self, args, is_cropped, root = '/path/to/frames/only/folder', iext = 'png', replicates = 1):
    ...
    self.image_list = []
    im1 = frame_utils.read_gen(images[0])
    im2 = frame_utils.read_gen(images[1])
    im3 = frame_utils.read_gen(images[2])
    im4 = frame_utils.read_gen(images[3])
    im5 = frame_utils.read_gen(images[4])
    im6 = frame_utils.read_gen(images[5])
    im7 = frame_utils.read_gen(images[6])
    im8 = frame_utils.read_gen(images[7])
    im9 = frame_utils.read_gen(images[8])
    im10 = frame_utils.read_gen(images[9])
    im11 = frame_utils.read_gen(images[10])
    im12 = frame_utils.read_gen(images[11])
    im13 = frame_utils.read_gen(images[12])
    im14 = frame_utils.read_gen(images[13])
    im15 = frame_utils.read_gen(images[14])
    im16 = frame_utils.read_gen(images[15])
    im17 = frame_utils.read_gen(images[16])
    im18 = frame_utils.read_gen(images[17])
    im19 = frame_utils.read_gen(images[18])
    im20 = frame_utils.read_gen(images[19])
    im21 = frame_utils.read_gen(images[20])
    im22 = frame_utils.read_gen(images[21])
    im23 = frame_utils.read_gen(images[22])
    im24 = frame_utils.read_gen(images[23])
    im25 = frame_utils.read_gen(images[24])
    im26 = frame_utils.read_gen(images[25])
    im27 = frame_utils.read_gen(images[26])
    im28 = frame_utils.read_gen(images[27])
    im29 = frame_utils.read_gen(images[28])
    im30 = frame_utils.read_gen(images[29])
    im31 = frame_utils.read_gen(images[30])
    im32 = frame_utils.read_gen(images[31])
    im33 = frame_utils.read_gen(images[32])
    im34 = frame_utils.read_gen(images[33])
    im35 = frame_utils.read_gen(images[34])
    im36 = frame_utils.read_gen(images[35])
    im37 = frame_utils.read_gen(images[36])
    im38 = frame_utils.read_gen(images[37])
    im39 = frame_utils.read_gen(images[38])
    im40 = frame_utils.read_gen(images[39])
    im41 = frame_utils.read_gen(images[40])
    im42 = frame_utils.read_gen(images[41])
    im43 = frame_utils.read_gen(images[42])
    im44 = frame_utils.read_gen(images[43])
    im45 = frame_utils.read_gen(images[44])
    im46 = frame_utils.read_gen(images[45])
    im47 = frame_utils.read_gen(images[46])
    im48 = frame_utils.read_gen(images[47])
    im49 = frame_utils.read_gen(images[48])
    im50 = frame_utils.read_gen(images[49])
